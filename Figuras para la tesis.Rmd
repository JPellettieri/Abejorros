...
###Gráfico de promedio de ingestas, discriminando por tratamiento
Datos %>%
  group_by(Tratamiento) %>%
  summarise(Ingesta_promedio = mean(Ingestas, na.rm = TRUE)) %>%
  ggplot(aes(x = Tratamiento, y = Ingesta_promedio, fill = Tratamiento)) +
  geom_col(color = "black") +
  labs(
    title = "Ingesta promedio en función del tratamiento",
    x = "Tratamiento",
    y = "Ingestas promedio"
  ) +
  theme_minimal() +
