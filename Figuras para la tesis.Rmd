...
MAprePeso <-glmer(A ~ as.factor(QuintilPeso) + (1|Tratamiento) + (1|Nido), 
...
# Ajustar modelo logístico
MRecPeso <- glmer(Recuerda ~ as.factor(QuintilPeso)+(1|Nido), data = Datos, family = binomial)
summary(MRecPeso)  
anova(MRecPeso)    #N/S
...
Datos$Peso <- as.numeric((Datos$Peso))
summary (Datos$Peso)
Datos$TercilPeso<-ntile(Datos$Peso, 3) #poner 5 si quiero los quintiles
