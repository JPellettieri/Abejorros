...
ggplot(Ingestas, aes(x = as.factor(Condicionamiento), y = Probabilidad)) +
  ...
  labs(title = "Probabilidad de recordar el olor a las 24hs en función de la cantidad de ingestas en el entrenamiento",
...
ggplot(Respuesta, aes(x = Tratamiento, y = Porcentaje)) +
  ...
  labs(title = "Porcentaje de Abejorros respondieron a PER en función del tratamiento",
       x = "Tratamiento",
       y = "Porcentaje (%)") +
  theme_minimal()
```
