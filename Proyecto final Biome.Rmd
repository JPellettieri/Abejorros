...
```
Los datos muestran que los abejorros estudiados que fueron sometidos a recompenzas con concentraciones traza de Arginina y/o cafeina tienen una mayor tasa de respuesta a la evalucion de PER realizada a las 24hs. Tambien se puede destacar un porcentaje de respuesta mayor en los individuos que consumiero ambios compuestos al simultaneo. Por ultimo el control "sin olor" no muestra ningun individuo que responda a la evaluacion PER afirmando que el protocolo aplicado fue adecuado.
